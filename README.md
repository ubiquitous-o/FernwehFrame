...
Production monitor: **Newsoul 22MT01-S** (22-inch, 2560×1440) in portrait orientation. After mounting, press `C` → `M` and enter the measured visible width in mm for true physical scale — for this monitor the measured value is **268 mm**, which renders the postcards at exact hagaki size (148×100 mm).
...
└── server.js                     # Zero-dependency static server (local/kiosk mode)
```
